...
function sendImgToContent(){
  ...
  //stackoverflow.com/questions/15575030/chrome-extension-send-message-from-background-to-content-script
  //sudo code check it out later:
  //listenToMessages(if messge.text == clicked --> send response)
